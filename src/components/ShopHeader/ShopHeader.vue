        ...
        <div  class="mask-wrapper">
          <div  class="mask-main"><h1 >{{info.name}}</h1>
            <div  class="stars-wrapper">
              <Stars :score="info.score" :size="48" />
            </div>
            <div  class="info">
              <div  class="line"></div>
